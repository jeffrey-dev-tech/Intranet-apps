        ...
        <table border="1" cellpadding="8" cellspacing="0" width="100%" style="border-collapse: collapse; font-family: Arial, sans-serif; font-size: 14px; color: #333;">
            <tr>
                <td style="font-weight: bold; background-color: #ffffff; width: 30%;" colspan="2" align="center">
                    <h2>{{ str_replace('_', ' ', $type_request) }}</h2>

                </td>
            </tr>

            <tr>
                <td style="font-weight: bold; background-color: #ffffff; width: 30%;">Type of Request</td>
                <td>{{ $type_request }}</td>
            </tr>

            @if($type_request === 'Repair_Request')
              <tr>
            ...
            @elseif($type_request === 'Borrow_Item')
                <tr>
                    <td style="font-weight: bold; background-color: #ffffff;">Reference #</td>
                    <td>{{ $reference_no ?? 'N/A' }}</td>
                </tr>
                ...
                <tr>
                    ...
                    <td>{{ $request_data['item_name'] ?? 'N/A' }}</td>
                </tr>
                <tr>
                    <td style="font-weight: bold; background-color: #ffffff;">Date Needed</td>
                    <td>{{ $request_data['date_needed'] ?? 'N/A' }}</td>
                </tr>
                <tr>
            ...
            @else
                <tr>
                    <td style="font-weight: bold; background-color: #ffffff;" colspan="2" align="center">
                        Additional information not available for this request type.
                    </td>
                </tr>
            @endif
