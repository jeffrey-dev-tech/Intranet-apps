...
<tr>
    ...
    <tr>
        <td style="font-weight: bold; background-color: #ffffff;">Captain Name</td>
        <td>{{ $captain_name }}</td>
    </tr>
    <tr>
        <td style="font-weight: bold; background-color: #ffffff;">Invitation Code</td>
...
<tr>
    <td colspan="2" align="center" style="padding: 20px;">
        <a href="https://intranet.sanden.net/activities/team-registration" 
           style="
