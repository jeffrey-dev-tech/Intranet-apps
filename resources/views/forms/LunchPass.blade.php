...
<div class="page-content">
    <nav class="page-breadcrumb">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active" aria-current="page">Lunch Pass Form</li>
					</ol>
				</nav>
		<div class="row">
                    ...
                    <hr>
										<div class="title-form">
											<h6 class="card-title" style="font-size:25px;">Employee Breaktime & Lunch Pass Form</h6>
										</div>
                    
									</div>
		    <form id="Lunch_Pass_Form" enctype="multipart/form-data">
          <div class="row">
              ...
              <div class="form-group">
               ...
               <input type="time" id="time_out"  class="form-control">
              </div>
            </div>
          		<div class="col-sm-4">
              <div class="form-group">
