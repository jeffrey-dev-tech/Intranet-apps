...
INSERT INTO `it_request_approval` VALUES (1,'RR-202509-001','Jeffrey C. Salagubang','IT','mis.scp@sanden-rs.com','','Approved','fsdfghj','2025-09-04 06:54:07','2025-09-05 05:19:46'),(11,'NIS-202509-001','Dichoso Fernan','Manager','fernan.dichoso.cj@sanden-rs.com','Manager','Pending','','2025-09-04 07:53:31','2025-09-04 07:53:31'),(12,'RR-202509-003','MIS SM','IT','mis.scp@sanden-rs.com','IT','Pending','','2025-09-04 08:03:32','2025-09-04 08:03:32'),(19,'RR-202509-004','MIS SM','IT','mis.scp@sanden-rs.com','IT','Pending','','2025-09-05 03:47:12','2025-09-05 03:47:12'),(21,'NIS-202509-001','MIS','IT','mis.scp@sanden-rs.com','IT','Pending','','2025-09-04 07:53:31','2025-09-04 07:53:31'),(22,'RR-202510-001','MIS SM','IT','mis.scp@sanden-rs.com','IT','Pending','','2025-10-16 06:38:29','2025-10-16 06:38:29');
...
CREATE TABLE `it_request_tbl` (
  ...
  `status` enum('Pending','In Progress','Completed','Rejected','Approved') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Pending',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `sessions` VALUES ('oI6pbKK2ssDrZswNSUOtMmmDamsBXI8iP6LcaTpd',119,'192.168.5.156','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/141.0.0.0 Safari/537.36','',1760596963);
...
-- Dump completed on 2025-10-16 15:15:01
